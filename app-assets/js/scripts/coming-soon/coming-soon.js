...
$(document).ready(function() {
    ...
    $('#clockImage').countdown('2017/11/18').on('update.countdown', function(event) {
    ...
    $('#clockFlat').countdown('2017/11/18').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
    ...
    $('#clockMinimal').countdown('2017/11/18').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
